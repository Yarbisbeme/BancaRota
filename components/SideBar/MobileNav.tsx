  ...
  return (
    <section className="w-fulll max-w-[264px]">
      <Sheet>
        ...
        <SheetContent side="left" className="border-none bg-white p-4 pb-8" >
          <SheetTitle>
            <Link href={'/'} className="cursor-pointer items-center gap-2 px-4 flex -ml-2">
              <Image
                src={'/icons/logoY.svg'}
                alt="Logo"
                width={32}
          ...
          <div className="mobilenav-sheet">
            <SheetClose asChild>
              <nav className="flex flex-col h-full gap-6 pt-16 sm:pt-10 text-white">
